...
import 'package:uts/menu_profil.dart';
      ...
      appBar: PreferredSize(
        child: Container(
          decoration: BoxDecoration(
            boxShadow: [
              BoxShadow(
                  color: Color.fromARGB(121, 109, 130, 253).withOpacity(1)),
            ],
        ...
        child: Column(
          ...
          children: [
            SingleChildScrollView(
                scrollDirection: Axis.horizontal, child: Kategori()),
            SizedBox(
              height: 10,
            ),
            hotHot(),
